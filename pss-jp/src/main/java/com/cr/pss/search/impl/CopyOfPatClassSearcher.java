 ...
 * @author lq
 */
public class CopyOfPatClassSearcher extends AbstractSearcher {
	private static final Logger logger = LoggerFactory
			.getLogger(CopyOfPatClassSearcher.class);
	...
	public CopyOfPatClassSearcher(String strSources, String strWhere,
