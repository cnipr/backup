...
public class CopyOfEnOverviewSearcher extends AbstractSearcher {
	private static final Logger logger = LoggerFactory
			.getLogger(CopyOfEnOverviewSearcher.class);
	...
	public CopyOfEnOverviewSearcher(String strSources, String strWhere,
...
//					} else {
						if (displayCols != null && !displayCols.equals("")) {
							...
							patentInfo.setAb(trsresultset.getString("ABS",
									"red"));
...
//					}
			...
			new PSSException("3002", e.getMessage(),
					e.getMessage(), "EnOverviewSearcher", "doSearch", "trs");
		}
